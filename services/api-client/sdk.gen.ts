...
/**
 * Получить бронирования в статусе pending_confirmation
 * Возвращает все бронирования сервисного центра в статусе ожидания подтверждения (pending_confirmation). Требуется аутентификация админа и доступ к указанному сервисному центру через projectUuid.
 * @param data The data for the request.
 * @param data.serviceCenterUuid UUID сервисного центра
 * @returns AdminBookingListResponseDto Список бронирований в статусе pending_confirmation успешно получен
 * @throws ApiError
 */
export const adminBookingsGetPending = (data: AdminBookingsGetPendingData): CancelablePromise<AdminBookingsGetPendingResponse> => {
    return __request(OpenAPI, {
        method: 'GET',
